 ...
 * Same counter experiment as race_condition.c, but protected with a mutex.
 * Final value is always exactly NUM_THREADS * INCREMENTS_PER_THREAD.
 *
...
int main(void) {
    ...
    if (shared_counter == expected)
        printf("Result: CORRECT — mutex prevented all data races.\n");
    else
        printf("Result: ERROR — mutex implementation is broken.\n");
